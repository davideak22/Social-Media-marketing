...
export function PhotographyTitleScene() {
  return (
    <div className="h-full w-full bg-black text-white flex items-center justify-center p-8 relative overflow-hidden">
        {/* Subtle Background Gradient - Green/Teal specific for Content/Photo section */}
        <div className="absolute inset-0 bg-gradient-to-br from-neutral-900 via-black to-emerald-950/20" />
